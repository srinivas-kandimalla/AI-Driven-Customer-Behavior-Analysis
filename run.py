...
def run_app():
    ...
    models_missing = (
        not os.path.exists(SEGMENTATION_MODEL_PATH) or
        not os.path.exists(PURCHASE_MODEL_PATH) or
        not os.path.exists(CHURN_MODEL_PATH) or
        not os.path.exists(RECOMMENDATION_MODEL_PATH)
    )
    ...
    print("=" * 60)
    print(f"Customer Behavior Analysis Platform starting at: http://{API_HOST}:{API_PORT}")
